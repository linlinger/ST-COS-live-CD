...
#author: linlinger
#date 2020 Dec 10th.
#This script is used for build archiso based on xfce desktop enviroment
#validating user has root permission or not.

temp_dir="/home/archiso-xfce-tempfiles"
echo $temp_dir
if [ $(id -u) != "0" ];
then
...
mkarchiso -v -w $temp_dir -L COS-XFCE -P STP -p packages-xfce.86_64 ./xfce-profile
